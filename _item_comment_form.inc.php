...
$params = array_merge( array(
		...
		'form_title_start'     => '<div class="'.( $Session->get('core.preview_Comment') ? 'panel-danger' : '' ).'">'
																.'<h4 class="comment-form--title"><strong>',
		'form_title_end'       => '</strong></h4><div class="comment-form--body">',
