...
$params = array_merge( array(
		...
		'form_title_start'     => '<div class="default-comment '.( $Session->get( 'core.preview_Comment'.( isset( $params['comment_type'] ) && $params['comment_type'] == 'meta' ? 'meta' : '' ) ) ? '' : '' ).'">'
																.'<div class="panel-heading"><h4 class="panel-title comment-form--title">',
