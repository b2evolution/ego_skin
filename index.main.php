...
<header class="row">
	...
	<div class="col-md-12">
		...
		<?php if ( $disp == 'front' && $Skin->get_setting( 'fr_sec_enable' ) == true ) { ?>
			<img src="<?php  ?>" />
		<?php } ?>
...
<div class="row">
	...
	<div class="<?php if ( $disp == 'front' && $Skin->get_setting( 'front_sidebar' ) == false ) { echo 'col-md-12'; } else { echo $Skin->get_column_class(); } ?>">
	...
	<?php
	if ( $disp == 'front' && $Skin->get_setting( 'front_sidebar' ) == false ) {
		echo '';
	}
	else {
	...
	} // if  not disable front page sidebar ?>
